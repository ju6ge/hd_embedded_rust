#![doc = "Peripheral access API for ATSAME70Q21 microcontrollers (generated using svd2rust v0.16.1)\n\nYou can find an overview of the API [here].\n\n[here]: https://docs.rs/svd2rust/0.16.1/svd2rust/#peripheral-api"]
#![deny(missing_docs)]
#![deny(warnings)]
...
unsafe impl bare_metal::Nr for Interrupt {
    ...
    fn nr(&self) -> u8 {
        match *self {
            ...
            Interrupt::ACC => 33,
            Interrupt::USBHS => 34,
            Interrupt::MCAN0_INT0 => 35,
            Interrupt::MCAN0_INT1 => 36,
            Interrupt::MCAN1_INT0 => 37,
            Interrupt::MCAN1_INT1 => 38,
            Interrupt::GMAC => 39,
            Interrupt::AFEC1 => 40,
            Interrupt::TWIHS2 => 41,
            Interrupt::SPI1 => 42,
            ...
            Interrupt::SDRAMC => 62,
            Interrupt::RSWDT => 63,
            Interrupt::GMAC_Q1 => 66,
            Interrupt::GMAC_Q2 => 67,
            Interrupt::IXC => 68,
        }
    }
}
