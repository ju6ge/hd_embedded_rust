#[doc = "Reader of register GMAC_ST2CW06"]
pub type R = crate::R<u32, super::GMAC_ST2CW06>;
#[doc = "Writer for register GMAC_ST2CW06"]
pub type W = crate::W<u32, super::GMAC_ST2CW06>;
#[doc = "Register GMAC_ST2CW06 `reset()`'s with value 0"]
impl crate::ResetValue for super::GMAC_ST2CW06 {
    type Type = u32;
    #[inline(always)]
