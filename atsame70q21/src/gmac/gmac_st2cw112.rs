#[doc = "Reader of register GMAC_ST2CW112"]
pub type R = crate::R<u32, super::GMAC_ST2CW112>;
#[doc = "Writer for register GMAC_ST2CW112"]
pub type W = crate::W<u32, super::GMAC_ST2CW112>;
#[doc = "Register GMAC_ST2CW112 `reset()`'s with value 0"]
impl crate::ResetValue for super::GMAC_ST2CW112 {
    type Type = u32;
    #[inline(always)]
...
impl From<OFFSSTRT_A> for u8 {
    ...
    fn from(variant: OFFSSTRT_A) -> Self {
        match variant {
            OFFSSTRT_A::FRAMESTART => 0,
            OFFSSTRT_A::ETHERTYPE => 1,
            OFFSSTRT_A::IP => 2,
            OFFSSTRT_A::TCP_UDP => 3,
        }
    }
}
