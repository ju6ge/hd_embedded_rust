#[doc = "Writer for register GMAC_IER"]
pub type W = crate::W<u32, super::GMAC_IER>;
#[doc = "Register GMAC_IER `reset()`'s with value 0"]
impl crate::ResetValue for super::GMAC_IER {
    type Type = u32;
    #[inline(always)]
