#[doc = "Writer for register GMAC_IDRPQ[%s]"]
pub type W = crate::W<u32, super::GMAC_IDRPQ>;
#[doc = "Register GMAC_IDRPQ[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::GMAC_IDRPQ {
    type Type = u32;
    #[inline(always)]
