#[doc = "Writer for register GMAC_IDR"]
pub type W = crate::W<u32, super::GMAC_IDR>;
#[doc = "Register GMAC_IDR `reset()`'s with value 0"]
impl crate::ResetValue for super::GMAC_IDR {
    type Type = u32;
    #[inline(always)]
