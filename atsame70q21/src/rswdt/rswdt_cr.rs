#[doc = "Writer for register RSWDT_CR"]
pub type W = crate::W<u32, super::RSWDT_CR>;
#[doc = "Register RSWDT_CR `reset()`'s with value 0"]
impl crate::ResetValue for super::RSWDT_CR {
    type Type = u32;
    #[inline(always)]
