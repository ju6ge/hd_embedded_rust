#[doc = "Reader of register ISI_WPMR"]
pub type R = crate::R<u32, super::ISI_WPMR>;
#[doc = "Writer for register ISI_WPMR"]
pub type W = crate::W<u32, super::ISI_WPMR>;
#[doc = "Register ISI_WPMR `reset()`'s with value 0"]
impl crate::ResetValue for super::ISI_WPMR {
    type Type = u32;
    #[inline(always)]
