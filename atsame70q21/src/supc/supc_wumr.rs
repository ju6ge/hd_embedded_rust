...
impl From<LPDBCEN0_A> for bool {
    ...
    fn from(variant: LPDBCEN0_A) -> Self {
        match variant {
            LPDBCEN0_A::NOT_ENABLE => false,
            LPDBCEN0_A::ENABLE => true,
        }
    }
}
...
impl From<LPDBCEN1_A> for bool {
    ...
    fn from(variant: LPDBCEN1_A) -> Self {
        match variant {
            LPDBCEN1_A::NOT_ENABLE => false,
            LPDBCEN1_A::ENABLE => true,
        }
    }
}
...
impl From<LPDBCCLR_A> for bool {
    ...
    fn from(variant: LPDBCCLR_A) -> Self {
        match variant {
            LPDBCCLR_A::NOT_ENABLE => false,
            LPDBCCLR_A::ENABLE => true,
        }
    }
}
...
impl From<WKUPDBC_A> for u8 {
    ...
    fn from(variant: WKUPDBC_A) -> Self {
        match variant {
            ...
            WKUPDBC_A::_3_SLCK => 1,
            WKUPDBC_A::_32_SLCK => 2,
            WKUPDBC_A::_512_SLCK => 3,
            WKUPDBC_A::_4096_SLCK => 4,
            WKUPDBC_A::_32768_SLCK => 5,
        }
    }
}
