...
impl From<NDE_A> for bool {
    ...
    fn from(variant: NDE_A) -> Self {
        match variant {
            NDE_A::DSCR_FETCH_DIS => false,
            NDE_A::DSCR_FETCH_EN => true,
        }
    }
}
...
impl From<NDSUP_A> for bool {
    ...
    fn from(variant: NDSUP_A) -> Self {
        match variant {
            NDSUP_A::SRC_PARAMS_UNCHANGED => false,
            NDSUP_A::SRC_PARAMS_UPDATED => true,
        }
    }
}
...
impl From<NDDUP_A> for bool {
    ...
    fn from(variant: NDDUP_A) -> Self {
        match variant {
            NDDUP_A::DST_PARAMS_UNCHANGED => false,
            NDDUP_A::DST_PARAMS_UPDATED => true,
        }
    }
}
