...
impl From<TYPE_A> for bool {
    ...
    fn from(variant: TYPE_A) -> Self {
        match variant {
            TYPE_A::MEM_TRAN => false,
            TYPE_A::PER_TRAN => true,
        }
    }
}
...
impl From<DSYNC_A> for bool {
    ...
    fn from(variant: DSYNC_A) -> Self {
        match variant {
            DSYNC_A::PER2MEM => false,
            DSYNC_A::MEM2PER => true,
        }
    }
}
...
impl From<SWREQ_A> for bool {
    ...
    fn from(variant: SWREQ_A) -> Self {
        match variant {
            SWREQ_A::HWR_CONNECTED => false,
            SWREQ_A::SWR_CONNECTED => true,
        }
    }
}
...
impl From<MEMSET_A> for bool {
    ...
    fn from(variant: MEMSET_A) -> Self {
        match variant {
            MEMSET_A::NORMAL_MODE => false,
            MEMSET_A::HW_MODE => true,
        }
    }
}
...
impl From<INITD_A> for bool {
    ...
    fn from(variant: INITD_A) -> Self {
        match variant {
            INITD_A::IN_PROGRESS => false,
            INITD_A::TERMINATED => true,
        }
    }
}
