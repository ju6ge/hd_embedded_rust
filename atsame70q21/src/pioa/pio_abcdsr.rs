#[doc = "Reader of register PIO_ABCDSR[%s]"]
pub type R = crate::R<u32, super::PIO_ABCDSR>;
#[doc = "Writer for register PIO_ABCDSR[%s]"]
pub type W = crate::W<u32, super::PIO_ABCDSR>;
#[doc = "Register PIO_ABCDSR[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::PIO_ABCDSR {
    type Type = u32;
    #[inline(always)]
