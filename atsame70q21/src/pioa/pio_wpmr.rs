#[doc = "Reader of register PIO_WPMR"]
pub type R = crate::R<u32, super::PIO_WPMR>;
#[doc = "Writer for register PIO_WPMR"]
pub type W = crate::W<u32, super::PIO_WPMR>;
#[doc = "Register PIO_WPMR `reset()`'s with value 0"]
impl crate::ResetValue for super::PIO_WPMR {
    type Type = u32;
    #[inline(always)]
