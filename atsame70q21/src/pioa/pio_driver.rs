...
impl From<LINE0_A> for bool {
    ...
    fn from(variant: LINE0_A) -> Self {
        match variant {
            LINE0_A::LOW_DRIVE => false,
            LINE0_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE1_A> for bool {
    ...
    fn from(variant: LINE1_A) -> Self {
        match variant {
            LINE1_A::LOW_DRIVE => false,
            LINE1_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE2_A> for bool {
    ...
    fn from(variant: LINE2_A) -> Self {
        match variant {
            LINE2_A::LOW_DRIVE => false,
            LINE2_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE3_A> for bool {
    ...
    fn from(variant: LINE3_A) -> Self {
        match variant {
            LINE3_A::LOW_DRIVE => false,
            LINE3_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE4_A> for bool {
    ...
    fn from(variant: LINE4_A) -> Self {
        match variant {
            LINE4_A::LOW_DRIVE => false,
            LINE4_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE5_A> for bool {
    ...
    fn from(variant: LINE5_A) -> Self {
        match variant {
            LINE5_A::LOW_DRIVE => false,
            LINE5_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE6_A> for bool {
    ...
    fn from(variant: LINE6_A) -> Self {
        match variant {
            LINE6_A::LOW_DRIVE => false,
            LINE6_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE7_A> for bool {
    ...
    fn from(variant: LINE7_A) -> Self {
        match variant {
            LINE7_A::LOW_DRIVE => false,
            LINE7_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE8_A> for bool {
    ...
    fn from(variant: LINE8_A) -> Self {
        match variant {
            LINE8_A::LOW_DRIVE => false,
            LINE8_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE9_A> for bool {
    ...
    fn from(variant: LINE9_A) -> Self {
        match variant {
            LINE9_A::LOW_DRIVE => false,
            LINE9_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE10_A> for bool {
    ...
    fn from(variant: LINE10_A) -> Self {
        match variant {
            LINE10_A::LOW_DRIVE => false,
            LINE10_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE11_A> for bool {
    ...
    fn from(variant: LINE11_A) -> Self {
        match variant {
            LINE11_A::LOW_DRIVE => false,
            LINE11_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE12_A> for bool {
    ...
    fn from(variant: LINE12_A) -> Self {
        match variant {
            LINE12_A::LOW_DRIVE => false,
            LINE12_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE13_A> for bool {
    ...
    fn from(variant: LINE13_A) -> Self {
        match variant {
            LINE13_A::LOW_DRIVE => false,
            LINE13_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE14_A> for bool {
    ...
    fn from(variant: LINE14_A) -> Self {
        match variant {
            LINE14_A::LOW_DRIVE => false,
            LINE14_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE15_A> for bool {
    ...
    fn from(variant: LINE15_A) -> Self {
        match variant {
            LINE15_A::LOW_DRIVE => false,
            LINE15_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE16_A> for bool {
    ...
    fn from(variant: LINE16_A) -> Self {
        match variant {
            LINE16_A::LOW_DRIVE => false,
            LINE16_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE17_A> for bool {
    ...
    fn from(variant: LINE17_A) -> Self {
        match variant {
            LINE17_A::LOW_DRIVE => false,
            LINE17_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE18_A> for bool {
    ...
    fn from(variant: LINE18_A) -> Self {
        match variant {
            LINE18_A::LOW_DRIVE => false,
            LINE18_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE19_A> for bool {
    ...
    fn from(variant: LINE19_A) -> Self {
        match variant {
            LINE19_A::LOW_DRIVE => false,
            LINE19_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE20_A> for bool {
    ...
    fn from(variant: LINE20_A) -> Self {
        match variant {
            LINE20_A::LOW_DRIVE => false,
            LINE20_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE21_A> for bool {
    ...
    fn from(variant: LINE21_A) -> Self {
        match variant {
            LINE21_A::LOW_DRIVE => false,
            LINE21_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE22_A> for bool {
    ...
    fn from(variant: LINE22_A) -> Self {
        match variant {
            LINE22_A::LOW_DRIVE => false,
            LINE22_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE23_A> for bool {
    ...
    fn from(variant: LINE23_A) -> Self {
        match variant {
            LINE23_A::LOW_DRIVE => false,
            LINE23_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE24_A> for bool {
    ...
    fn from(variant: LINE24_A) -> Self {
        match variant {
            LINE24_A::LOW_DRIVE => false,
            LINE24_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE25_A> for bool {
    ...
    fn from(variant: LINE25_A) -> Self {
        match variant {
            LINE25_A::LOW_DRIVE => false,
            LINE25_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE26_A> for bool {
    ...
    fn from(variant: LINE26_A) -> Self {
        match variant {
            LINE26_A::LOW_DRIVE => false,
            LINE26_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE27_A> for bool {
    ...
    fn from(variant: LINE27_A) -> Self {
        match variant {
            LINE27_A::LOW_DRIVE => false,
            LINE27_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE28_A> for bool {
    ...
    fn from(variant: LINE28_A) -> Self {
        match variant {
            LINE28_A::LOW_DRIVE => false,
            LINE28_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE29_A> for bool {
    ...
    fn from(variant: LINE29_A) -> Self {
        match variant {
            LINE29_A::LOW_DRIVE => false,
            LINE29_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE30_A> for bool {
    ...
    fn from(variant: LINE30_A) -> Self {
        match variant {
            LINE30_A::LOW_DRIVE => false,
            LINE30_A::HIGH_DRIVE => true,
        }
    }
}
...
impl From<LINE31_A> for bool {
    ...
    fn from(variant: LINE31_A) -> Self {
        match variant {
            LINE31_A::LOW_DRIVE => false,
            LINE31_A::HIGH_DRIVE => true,
        }
    }
}
