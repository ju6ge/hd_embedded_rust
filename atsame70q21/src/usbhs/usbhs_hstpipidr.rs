#[doc = "Writer for register USBHS_HSTPIPIDR[%s]"]
pub type W = crate::W<u32, super::USBHS_HSTPIPIDR>;
#[doc = "Register USBHS_HSTPIPIDR[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::USBHS_HSTPIPIDR {
    type Type = u32;
    #[inline(always)]
