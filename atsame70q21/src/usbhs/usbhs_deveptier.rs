#[doc = "Writer for register USBHS_DEVEPTIER[%s]"]
pub type W = crate::W<u32, super::USBHS_DEVEPTIER>;
#[doc = "Register USBHS_DEVEPTIER[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::USBHS_DEVEPTIER {
    type Type = u32;
    #[inline(always)]
