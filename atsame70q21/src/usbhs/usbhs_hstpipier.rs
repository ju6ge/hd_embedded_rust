#[doc = "Writer for register USBHS_HSTPIPIER[%s]"]
pub type W = crate::W<u32, super::USBHS_HSTPIPIER>;
#[doc = "Register USBHS_HSTPIPIER[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::USBHS_HSTPIPIER {
    type Type = u32;
    #[inline(always)]
