#[doc = "Writer for register USBHS_HSTPIPIFR[%s]"]
pub type W = crate::W<u32, super::USBHS_HSTPIPIFR>;
#[doc = "Register USBHS_HSTPIPIFR[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::USBHS_HSTPIPIFR {
    type Type = u32;
    #[inline(always)]
