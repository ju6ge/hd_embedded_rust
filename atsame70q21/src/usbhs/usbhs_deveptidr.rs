#[doc = "Writer for register USBHS_DEVEPTIDR[%s]"]
pub type W = crate::W<u32, super::USBHS_DEVEPTIDR>;
#[doc = "Register USBHS_DEVEPTIDR[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::USBHS_DEVEPTIDR {
    type Type = u32;
    #[inline(always)]
