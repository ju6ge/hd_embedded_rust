#[doc = "Writer for register USBHS_DEVEPTIFR[%s]"]
pub type W = crate::W<u32, super::USBHS_DEVEPTIFR>;
#[doc = "Register USBHS_DEVEPTIFR[%s] `reset()`'s with value 0"]
impl crate::ResetValue for super::USBHS_DEVEPTIFR {
    type Type = u32;
    #[inline(always)]
