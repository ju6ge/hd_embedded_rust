...
#[doc = "Register MATRIX_MCFG[%s] `reset()`'s with value 0"]
...
impl From<ULBT_A> for u8 {
    ...
    fn from(variant: ULBT_A) -> Self {
        match variant {
            ULBT_A::UNLTD_LENGTH => 0,
            ULBT_A::SINGLE_ACCESS => 1,
            ULBT_A::_4BEAT_BURST => 2,
            ULBT_A::_8BEAT_BURST => 3,
            ULBT_A::_16BEAT_BURST => 4,
            ULBT_A::_32BEAT_BURST => 5,
            ULBT_A::_64BEAT_BURST => 6,
            ULBT_A::_128BEAT_BURST => 7,
        }
    }
}
