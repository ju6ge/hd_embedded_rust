...
impl From<SELMINUS_A> for u8 {
    ...
    fn from(variant: SELMINUS_A) -> Self {
        match variant {
            ...
            SELMINUS_A::DAC0 => 2,
            SELMINUS_A::DAC1 => 3,
            SELMINUS_A::AFE0_AD0 => 4,
            SELMINUS_A::AFE0_AD1 => 5,
            SELMINUS_A::AFE0_AD2 => 6,
            SELMINUS_A::AFE0_AD3 => 7,
        }
    }
}
...
impl From<SELPLUS_A> for u8 {
    ...
    fn from(variant: SELPLUS_A) -> Self {
        match variant {
            SELPLUS_A::AFE0_AD0 => 0,
            SELPLUS_A::AFE0_AD1 => 1,
            SELPLUS_A::AFE0_AD2 => 2,
            SELPLUS_A::AFE0_AD3 => 3,
            SELPLUS_A::AFE0_AD4 => 4,
            SELPLUS_A::AFE0_AD5 => 5,
            SELPLUS_A::AFE1_AD0 => 6,
            SELPLUS_A::AFE1_AD1 => 7,
        }
    }
}
