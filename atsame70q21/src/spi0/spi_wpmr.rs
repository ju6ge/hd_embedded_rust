#[doc = "Reader of register SPI_WPMR"]
pub type R = crate::R<u32, super::SPI_WPMR>;
#[doc = "Writer for register SPI_WPMR"]
pub type W = crate::W<u32, super::SPI_WPMR>;
#[doc = "Register SPI_WPMR `reset()`'s with value 0"]
impl crate::ResetValue for super::SPI_WPMR {
    type Type = u32;
    #[inline(always)]
