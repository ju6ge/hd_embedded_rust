...
impl From<OPTL_A> for u8 {
    ...
    fn from(variant: OPTL_A) -> Self {
        match variant {
            OPTL_A::OPTION_1BIT => 0,
            OPTL_A::OPTION_2BIT => 1,
            OPTL_A::OPTION_4BIT => 2,
            OPTL_A::OPTION_8BIT => 3,
        }
    }
}
...
impl From<ADDRL_A> for bool {
    ...
    fn from(variant: ADDRL_A) -> Self {
        match variant {
            ADDRL_A::_24_BIT => false,
            ADDRL_A::_32_BIT => true,
        }
    }
}
...
impl From<TFRTYP_A> for u8 {
    ...
    fn from(variant: TFRTYP_A) -> Self {
        match variant {
            TFRTYP_A::TRSFR_READ => 0,
            TFRTYP_A::TRSFR_READ_MEMORY => 1,
            TFRTYP_A::TRSFR_WRITE => 2,
            TFRTYP_A::TRSFR_WRITE_MEMORY => 3,
        }
    }
}
